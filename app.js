window.onload = () =>
{
  const ImgLoading = document.getElementById('loadingImg');

  //La función, a diferencia de arrow function, puede ser llamada desde cualquier parte
  ...
  const buttonTwo = document.getElementById('btnOne');
  buttonTwo.addEventListener("click", () => {
    ...
    fetch(`https://cors-anywhere.herokuapp.com/http://shibe.online/api/cats?count=10&urls=true&httpsUrls=true`) //Recibe la URL donde se va a hacer la consulta
      ...
      { //recibimos el JSON en este punto
  ...
  const buttonThree = document.getElementById('btnOne');
